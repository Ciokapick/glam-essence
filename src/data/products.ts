...
export const products: { [key: string]: Product } = {
  "parfum-floral-extravagance": {
    ...
    gallery: ["/ParfumFloralExtravagance.jpg"],
  ...
  "parfum-oriental-mystique": {
    ...
    gallery: ["/ParfumOrientalMystique.png"],
  ...
  "parfum-woody-elegance": {
    ...
    gallery: ["/ParfumWoodyElegance.jpg"],
  ...
  "parfum-aquatic-breeze": {
    ...
    gallery: ["/ParfumAquaticBreeze.avif"],
  ...
  "crema-hidratanta-luxury": {
    ...
    price: 129.99,
    oldPrice: 152.99,
    image: "/products/skincare/face-cream.webp",
    gallery: ["/products/skincare/face-cream.webp"],
  ...
  "crema-contur-ochi-anti-age": {
    ...
    price: 149.99,
    image: "/products/skincare/eye-cream.webp",
    gallery: ["/products/skincare/eye-cream.webp"],
    category: "Cremă ochi",
    rating: 5,
    reviewCount: 24,
  ...
  "crema-de-maini-silk": {
    ...
    price: 59.99,
    image: "/products/skincare/hand-cream.webp",
    gallery: ["/products/skincare/hand-cream.webp"],
  ...
  "crema-de-corp-intense": {
    ...
    price: 89.99,
    image: "/products/skincare/body-cream.webp",
    gallery: ["/products/skincare/body-cream.webp"],
    category: "Cremă corp",
    isNew: true,
    rating: 4,
    reviewCount: 29,
  ...
  "crema-nutritiva-de-noapte": {
    ...
    price: 139.99,
    image: "/products/skincare/night-cream.webp",
    gallery: ["/products/skincare/night-cream.webp"],
    category: "Cremă față",
    rating: 5,
    reviewCount: 26,
  ...
  "crema-anticelulitică": {
    ...
    price: 109.99,
    image: "/products/skincare/body-treatment.webp",
    gallery: ["/products/skincare/body-treatment.webp"],
    category: "Cremă corp",
    isSale: true,
    discount: 10,
    rating: 4,
  ...
  "ser-facial-radiance": {
    ...
    gallery: ["/products/skincare/face-serum.webp"],
    category: "Ser",
    rating: 5,
    reviewCount: 41,
  ...
  "masca-faciala-detox": {
    ...
    price: 79.99,
    image: "/products/skincare/detox-mask.webp",
    gallery: ["/products/skincare/detox-mask.webp"],
    category: "Mască",
    isNew: true,
    rating: 4,
    reviewCount: 27,
  ...
  "spuma-de-curatare": {
    ...
    price: 69.99,
    image: "/products/skincare/cleansing-foam.webp",
    gallery: ["/products/skincare/cleansing-foam.webp"],
    category: "Curățare",
    rating: 4,
    reviewCount: 35,
  ...
  "tonic-purificator": {
    ...
    price: 59.99,
    image: "/products/skincare/toner.webp",
    gallery: ["/products/skincare/toner.webp"],
    category: "Tonic",
    rating: 4,
    reviewCount: 30,
  ...
  "ulei-de-fata-nutritiv": {
    ...
    price: 129.99,
    image: "/products/skincare/face-oil.webp",
    gallery: ["/products/skincare/face-oil.webp"],
    category: "Ulei",
    isSale: true,
    discount: 20,
    rating: 5,
