...
const ParfumOrientalMystique = () => {
  const { addToCart } = useCart();
  const { addToWishlist, removeFromWishlist, isInWishlist } = useWishlist();
  const product = products["parfum-oriental-mystique"];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div>
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="text-sm text-muted-foreground">{product.reviewCount || 5} reviews</span>
              </div>
              ...
              <p className="text-muted-foreground mb-8">
                Un parfum oriental sofisticat, cu note calde de vanilie, mosc și lemn de santal. Perfect pentru serile elegante și ocaziile speciale.
              </p>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span>Note de vârf: bergamotă, cardamom</span>
                  </li>
                  <li className="flex items-start">
                    <div className="h-2 w-2 rounded-full bg-beauty-magenta mt-1.5 mr-3"></div>
                    <span>Note de mijloc: trandafir, iasomie</span>
                  </li>
                  <li className="flex items-start">
                    <div className="h-2 w-2 rounded-full bg-beauty-magenta mt-1.5 mr-3"></div>
                    <span>Note de bază: mosc, ambră, vanilie</span>
                  </li>
                  <li className="flex items-start">
                    <div className="h-2 w-2 rounded-full bg-beauty-magenta mt-1.5 mr-3"></div>
                    <span>Concentrație: Eau de Parfum</span>
                  </li>
                  <li className="flex items-start">
                    <div className="h-2 w-2 rounded-full bg-beauty-magenta mt-1.5 mr-3"></div>
                    <span>Persistență: 8-10 ore</span>
                  </li>
                </ul>
              </div>
            </div>
