...
const ParfumFreshCitrus = () => {
  const { addToCart } = useCart();
  const { addToWishlist, removeFromWishlist, isInWishlist } = useWishlist();
  const product = products["parfum-fresh-citrus"];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div>
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="text-sm text-muted-foreground">{product.reviewCount || 4} reviews</span>
              </div>
              ...
              <p className="text-muted-foreground mb-8">
                Un parfum revigorant cu note proaspete de citrice și accente verzi. Perfect pentru utilizarea de zi și pentru zilele călduroase de vară.
              </p>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span>Note de vârf: lămâie, lime, grapefruit</span>
                  </li>
                  <li className="flex items-start">
                    <div className="h-2 w-2 rounded-full bg-beauty-magenta mt-1.5 mr-3"></div>
                    <span>Note de mijloc: mentă, busuioc</span>
                  </li>
                  <li className="flex items-start">
                    <div className="h-2 w-2 rounded-full bg-beauty-magenta mt-1.5 mr-3"></div>
                    <span>Note de bază: lemn de cedru, mosc</span>
                  </li>
                  <li className="flex items-start">
                    <div className="h-2 w-2 rounded-full bg-beauty-magenta mt-1.5 mr-3"></div>
                    <span>Concentrație: Eau de Toilette</span>
                  </li>
                  <li className="flex items-start">
                    <div className="h-2 w-2 rounded-full bg-beauty-magenta mt-1.5 mr-3"></div>
                    <span>Persistență: 4-6 ore</span>
                  </li>
                </ul>
              </div>
            </div>
