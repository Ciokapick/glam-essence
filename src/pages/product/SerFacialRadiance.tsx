  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      try {
        ...
        const productData = allProducts["ser-facial-radiance"];
        ...
        if (productData) {
          ...
          setProduct({
            ...productData,
            stock,
            description: "Un ser facial inovator care oferă strălucire și luminozitate tenului obosit sau tern.",
            details: "Acest ser concentrat conține vitamine și antioxidanți care luptă împotriva semnelor îmbătrânirii și ajută la uniformizarea nuanței pielii. Formula sa ușoară pătrunde rapid în piele, oferind rezultate vizibile în doar câteva utilizări.",
            features: [
              "Bogat în vitaminele C și E",
              "Îmbunătățește strălucirea naturală a tenului",
              "Uniformizează nuanța pielii",
              "Reduce aspectul petelor pigmentare",
              "Formulă non-grasă, potrivită pentru toate tipurile de ten"
            ],
            reviewCount: 32,
            sku: "SF-RAD-001"
          });
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-8">
                <Button 
                  className="bg-beauty-hotpink hover:bg-beauty-hotpink/90 text-white flex-1"
                ...
                <Button 
                  ...
                  className={`${
                    isFavorite 
                      ...
                      : "border-beauty-hotpink/30 hover:bg-beauty-hotpink/5 hover:border-beauty-hotpink/50"
                  }`}
                ...
                <ul className="space-y-2">
                  {product.features.map((feature: string, index: number) => (
                    <li key={index} className="flex items-start">
                      <div className="h-2 w-2 rounded-full bg-beauty-hotpink mt-1.5 mr-3"></div>
                      <span>{feature}</span>
                    </li>
                  ))}
                </ul>
...
export default SerFacialRadiance;
